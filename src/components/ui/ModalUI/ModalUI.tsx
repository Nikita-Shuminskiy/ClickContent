            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Dialog.Panel
                                className={`relative transform transition-all w-full ${isFullScreen ? 'max-sm:min-h-[100vh]' : ''} ${dialogPanelClassname ?? ''}`}
                            ...
                            >
                                {isFullScreen ? (
                                    <div className={"px-[20px] pt-[31px]"}>
                                        ...
                                        >
                                            <Icon name={'arrowBack'} className="w-full h-full object-cover"/>
                                        </button>
                                    </div>
                                ) : (
                                    hasCloseBtn && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {title && (
                                            <h3 className={`text-[32px] ${isTextLeft ? 'text-left' : 'text-center'} font-bold mb-4 max-sm:text-[24px]`}>
                                                {title}
                                            </h3>
                                        )}
                                        {subtitle && (
                                    ...
                                    {modalBottom && <div
                                        className={modalBottomClassName ? modalBottomClassName : ''}>{modalBottom}</div>}
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
