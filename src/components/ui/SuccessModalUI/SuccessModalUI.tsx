  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center h-full">
        <div className="max-w-[240px] -mt-[180px] max-md:-mt-[120px] w-full max-md:max-w-[180px] max-sm:max-w-[152px] max-xs:-mt-[100px] max-sm:-mt-[90px]">
        ...
        <div className="flex flex-col justify-center relative w-full">
          ...
          <div className="flex w-full items-center justify-center gap-[16px] pr-[12px] pl-[32px] py-[8px] rounded-[60px] border border-solid border-white/30 max-xs:border-none mb-3 max-xs:p-0 max-xs:flex-wrap">
            <div className="flex items-center flex-grow justify-center gap-[8px] py-[14px] overflow-hidden max-xs:border border-solid border-[#FFFFFF1A] max-xs:pb-[10px] max-xs:pt-[14px] max-xs:px-[32px] rounded-[60px]">
              <span className="w-[24px] h-[24px] shrink-0">
                <Icon name={"copyFileIcon"} className={"text-[#FFFFFFB2]"} />
              </span>
              <span
                className={`${
                  isFrozenUser ? "select-none" : "select-auto"
                } overflow-hidden line-clamp-1 text-ellipsis max-xs:text-base text-[#FFFFFFB2]`}
              >
                {copyLink}
              </span>
            </div>
            <FreezeWrapper>
              <button
                className={`p-6 max-xs:py-[16px] ${
                  isFrozenUser ? "min-w-[224px]" : "max-w-[224px]"
                } w-full bg-[#874AB0] text-white text-base leading-none rounded-[60px] max-xs:max-w-full`}
                onClick={() => {
