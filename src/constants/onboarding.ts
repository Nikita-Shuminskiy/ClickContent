...
export const OnboardingModalInfo = {
  [OnboardingKey.photographer]: {
    ...
    "1": {
      ...
      title:
        "Ты - начинающий фотограф и хочешь зарабатывать на своем контенте?",
  ...
  [OnboardingKey.chef]: {
    ...
    "1": {
      ...
      title:
        "Ты - начинающий блогер-кулинар и мечтаешь зарабатывать на своем таланте?",
      body: "С ClickContent процесс займет всего пару минут!",
    },
    "2": {
      img: chefImg,
  ...
  [OnboardingKey.teacher]: {
    ...
    "1": {
      ...
      imgText:
        "Обучаешь новым знаниям, но не можешь заработать больше обычного?",
      title:
        "Ты - репетитор или педагог и хочешь зарабатывать на своих знаниях?",
      body: "С ClickContent процесс займет всего пару минут!",
    },
    "2": {
      img: teacherImg,
