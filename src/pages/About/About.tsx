    ...
    <section className="pt-28 pb-8">
      ...
      <div className="container max-md:text-xs">
        <div className="flex flex-col gap-[5px]">
          <h1
            className={
              "text-2xl text-center font-bold mb-10 max-sm:text-2xl max-sm:mb-6"
            }
          ></h1>
        </div>
        <p style={{ marginBottom: "0.28cm" }}>
          <span className="font-bold text-xl max-sm:text-base">
        ...
        <p className="flex flex-col gap-1" style={{ marginBottom: "0.28cm" }}>
          ...
          <a className="hover:underline" href="mailto:support@clickcontent.eu">
            support@clickcontent.eu
          </a>
        </p>
        <p style={{ marginBottom: "0.28cm" }}>
          <span className="font-bold text-xl max-sm:text-base">
        ...
        <p style={{ marginBottom: "0.28cm" }}>
          ...
          <br />
          <a className="hover:underline" href="https://clickcontent.eu/">
            {" "}
            https://clickcontent.eu/
          </a>
        </p>
      </div>
    </section>
