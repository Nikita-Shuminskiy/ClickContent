        ...
        <section className="pt-[80px] pb-[80px] max-sm:pt-[40px] max-sm:pb-[40px]">
            <div className="container">
                ...
                <div className="flex items-start gap-8 max-lg:flex-col">
                    <div
                        className="w-2/4 h-[782px]  p-[40px] max-sm:p-[20px] rounded-[32px] bg-[#141414] overflow-hidden max-lg:w-full max-lg:h-[600px] max-sm:h-[550px] max-sm:rounded-3xl">
                        <SkeletonUI>
                    ...
                    <div
                        className="w-2/4 h-[782px] p-[40px] max-sm:p-[20px] rounded-[32px] bg-[#141414] overflow-hidden max-lg:w-full max-lg:h-[600px] max-sm:h-[450px] max-sm:rounded-3xl">
                        <SkeletonUI>
