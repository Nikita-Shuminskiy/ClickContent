...
export const ReceiptQuickLink: FunctionComponent<IProps> = memo(
  ({ payment }) => {
    ...
    const quickLinkPaid = payments?.find(
      (p) => p.id === payment.id && p.paymentId,
    );
    ...
    const onSendEmail = () =>
      sendMale({ male: payment.email, id: payment?.paymentId });
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="gap-[10px] flex-row flex justify-between max-sm:flex-col">
                      ...
                      <div className="gap-[10px] flex-row flex justify-between max-sm:flex-col">
                        <ButtonUI
                          isLoading={isPending}
                          className={"max-w-[50%] max-sm:max-w-full"}
                          onClick={onSendEmail}
                        >
                          Отправить на почту
                        </ButtonUI>
