...
export const ReceiptDonate = ({ payment }: { payment: IPaymentInfo }) => {
  ...
  return (
    <LoadingWrapper isLoading={isLoadingAim} skeleton={<ReceiptSkeleton />}>
      <section className="pt-[80px] pb-[80px] max-sm:pt-[40px] max-sm:pb-[40px]">
        <div className="container">
          ...
          <div className="max-w-[1150px] w-full flex items-start gap-8 justify-between mx-auto max-md:flex-col-reverse">
              ...
              <div className="flex flex-col gap-7 w-full bg-[#141414] py-[60px] px-14 text-white rounded-[35px] max-sm:p-6">
                <div>
                  <h3 className="text-lg">
                    ...
                    <span className="text-[#A354D9]"></span>
                  </h3>
                </div>
                {aim && (
                  <div
