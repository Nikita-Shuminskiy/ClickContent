...
export const ReceiptQuickLink: FunctionComponent<IProps> = memo(() => {
    ...
    const {data: quickLink, isLoading} = useGetQuickLink(quickLinkPaid?.id, quickLinkPaid?.paymentId)
    ...
    const formattedDate = new Date(quickLinkPaid?.date).toLocaleDateString('ru-RU', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric'
    })
                    ...
                    {!isHasQuicklink && (
                        <div className="mb-9">
                            ...
                            <span className="block text-2xl text-center max-sm:text-xl">
                                    {quickLinkPaid?.isGift ? "Ваш подарок отправлен" : "Оплата прошла успешно"}
                             </span>
                        </div>
                    )}
                    <div
                            ...
                            <div
                                ...
                                <div>
                                    <h3 className="text-lg">
                                        {quickLinkPaid?.isGift ? "Оплата прошла успешно" : `Покупка контента: ${quickLink?.title}`}
                                    </h3>
                                </div>
