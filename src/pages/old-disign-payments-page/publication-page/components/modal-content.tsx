...
export const ModalContent = memo(({
    ...
    const hasChangedNickName = useMemo(() => getHasChangeNickName(data?.user.nickName), [data?.user.nickName])
    ...
    return (
        <div
            className="w-full max-xs:bg-inherit bg-[#141414] py-[60px] px-14 flex text-white gap-8 rounded-[35px]  max-sm:flex-col max-xs:p-2 max-sm:p-6">
