...
export const Form = memo(({
    ...
    const shortLinkOrNickname = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
    ...
    return (
        ...
        >
            ...
            <CheckboxUI onChangeChecked={(e) => setIsConditionsChecked(e)}>
                <span className="text-[12px] leading-[16px] text-[#5F5F5F]">Я согласен с{" "}</span>
                {/*Todo ссылки на страницы проверить */}
                <Link className="underline text-[12px] leading-[16px] text-[#5F5F5F]" to="/terms">
                    условиями использования
                </Link>{" "} <span className="text-[12px] leading-[16px] text-[#5F5F5F]">и {' '}</span>
                <Link className="underline text-[12px] leading-[16px] text-[#5F5F5F]" to="/terms">
