      ...
      <div className="flex flex-col gap-25">
        {isTimeUp ? (
          <div className="flex flex-col items-center gap-8">
            ...
            <ButtonUI onClick={handleCloseModal} className="!py-[14px]">
              Попробовать снова
            </ButtonUI>
          </div>
        ) : (
          <div className="flex flex-col items-center gap-[100px]">
            <h2 className="text-[20px] leading-[24px] font-bold text-center">
              Отсканируйте{" "}
              <span className=" inline-block text-[#874AB0]">QR-код</span> в
              мобильном приложении вашего банка
            </h2>
            <div className="flex flex-col gap-[24px] items-center w-full">
              <div className="w-[256px] h-[244px] p-4 rounded-[24px] bg-white">
                <QRCode
                  value={modalParams?.url}
                  id="qr-code-sbp"
                  className="custom-qr-code"
                />
              </div>
              <span className="inline-block max-w-[256px] text-[14px] leading-[16.8px] text-center text-[#5F5F5F]">
