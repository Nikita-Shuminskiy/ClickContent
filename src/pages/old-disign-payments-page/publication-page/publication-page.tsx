...
const PublicationPage = memo(({ data, id }: IProps) => {
  ...
  return (
    <div
      ...
      } max-w-[540px] pb-[200px] overflow-auto w-full m-auto flex flex-row-reverse gap-5 items-start max-md:flex-col max-sm:pb-[200px] max-sm:overflow-auto max-sm:h-screen scrollbar-hide`}
    >
      <CloseModalButton />
      <ModalContent
