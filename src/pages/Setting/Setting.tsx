...
const TableSetting = ({ data }) => {
  ...
  const { isNotPassport, isNotCardsAndPassport } = useUserInfoContext();
  ...
  return (
    <>
      {isMobile ? (
        <FreezeWrapper>
          <div className="flex items-center gap-4 justify-between">
            <div className="max-w-[300px] items-start flex flex-col gap-2">
              ...
              <div className="max-w-[80%] w-full overflow-hidden line-clamp-1 text-left text-ellipsis break-all">
        ...
        <div className="w-full bg-color-vmire p-10 rounded-[32px] max-sm:bg-transparent max-sm:p-0 max-sm:rounded-none">
          ...
          <div className="max-w-[920px]">
            <div className="grid grid-cols-[0.45fr,_1fr,_0.45fr,_0.2fr] items-center gap-4 mb-4 max-sm:hidden">
            ...
            <ul className="grid gap-4 max-sm:gap-6">
              <FreezeWrapper>
                <li>
                  <div className="grid grid-cols-[0.45fr,_1fr,_0.45fr,_0.2fr] items-center gap-4 max-sm:grid-cols-1">
                    ...
                    <div className="flex items-center justify-between gap-4 w-full overflow-hidden">
                      ...
                      >
                        ...
                        <span className="max-w-[370px] w-full overflow-hidden break-all line-clamp-1 max-sm:w-[auto] max-sm:text-right">
                          {createCopyDonateLink(user?.nickName)}
                        </span>
                      </div>
                    </div>
...
const FormEditDonate = () => {
  ...
  return (
    <div className="w-full bg-color-vmire p-10 rounded-[32px] mb-4 relative max-sm:bg-transparent max-sm:p-0 max-sm:rounded-none">
      <SuccessModalUI
        hasCloseBtn={false}
    ...
    <div className="flex items-center gap-4 max-md:flex-col">
      ...
      <div className="w-[50%] grid grid-cols-2 gap-4 max-lg:grid-cols-1 max-lg:w-[40%] max-md:w-full">
        <div className="p-10 w-full grow bg-[#121212] rounded-[32px] relative max-sm:p-6 max-sm:rounded-3xl">
          <div className="flex items-center justify-center absolute -right-5 -top-5 w-24 h-24 rounded-[50%] bg-[#0e0e0e] max-sm:w-16 max-sm:h-16 max-sm:-right-2 max-sm:-top-2">
            <span className="flex items-center justify-center w-14 h-14 rounded-[50%] border border-solid border-white/30 text-white/30 text-2xl font-bold max-sm:w-9 max-sm:h-9 max-xs:text-xl">
              1
            </span>
          </div>
        ...
        <div className="p-10 w-full grow bg-[#121212] rounded-[32px] relative max-sm:p-6 max-sm:rounded-3xl">
          <div className="flex items-center justify-center absolute -bottom-7 -right-2 w-24 h-24 rounded-[50%] bg-[#0e0e0e] max-sm:w-16 max-sm:h-16 max-sm:-bottom-4">
            <span className="flex items-center justify-center w-14 h-14 rounded-[50%] border border-solid border-white/30 text-white/30 text-2xl font-bold max-sm:w-9 max-sm:h-9 max-xs:text-xl">
              2
            </span>
          </div>
