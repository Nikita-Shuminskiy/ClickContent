...
const Payouts = () => {
  ...
  const isDataLoading =
    isLoading || isPayoutsDataLoading || isIncomingPaymentsLoading;
    ...
    <section className=" pt-[80px] pb-[80px] max-sm:pt-[40px] max-sm:pb-[40px]">
      <div className="container">
        <div className="mb-10">
          ...
          <LoadingWrapper isLoading={isLoading} skeleton={<CardSkeleton />}>
            <CardsSlider />
          </LoadingWrapper>
        </div>
          ...
          <div className="rounded-[30px] bg-color-vmire p-10 pt-5 max-sm:p-0 max-sm:bg-transparent">
                ...
                {({ open }) => (
                  ...
                  >
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <ListboxOptions className="absolute max-h-60 max-sm:max-h-[94px] w-full max-sm:w-[127px] flex flex-col justify-center font-firstNeue max-sm:py-1.5 px-5 pt-1 pb-2 origin-top-right max-sm:rounded-2xl rounded-b-2xl right-auto left-0 overflow-hidden bg-[#202020] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            {finances === null ||
              ...
              (finances?.data?.length === 0 && (
                <div className="flex justify-center items-center py-60 max-xs:py-12 max-md:py-20 max-lg:py-48">
            ...
            {finances &&
              ...
              finances?.type == "incoming" && (
                <IncomingPaymentsTable
                  finances={
                    (getIdPayment && dataSearch) ||
                    (finances.data as IIncomingPaymentDto[])
                  }
                />
              )}
