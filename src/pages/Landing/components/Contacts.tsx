  ...
  return (
    <div className="min-h-screen  text-white p-8">
      <div className="max-w-4xl ">
        ...
        <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-8">
          <div className="space-y-6">
            <div className="flex items-center row justify-between max-sm:items-start max-sm:flex-col max-sm:gap-[2px] gap-6">
              <h2 className="font-PPNeueMachina font-extrabold whitespace-normal text-[96px] max-3xl:text-[52px] max-sm:text-[32px]">
                МЕНЯ ЗОВУТ
              </h2>
            ...
            <div className="flex items-center row justify-between max-sm:items-start max-sm:flex-col max-sm:gap-[2px] gap-6">
              <h2 className="font-PPNeueMachina font-extrabold whitespace-normal max-3xl:text-[52px] text-[96px] max-sm:text-[32px]">
                КОНТАКТ
              </h2>
              <div className="flex flex-col flex-1 w-full">
                <FormInputUI
            ...
            <div className="flex items-center row justify-between max-sm:items-start max-sm:flex-col max-sm:gap-[2px] gap-6">
              <h2 className="font-PPNeueMachina font-extrabold whitespace-normal text-[96px] max-sm:text-[32px] max-3xl:text-[52px]">
                СООБЩЕНИЕ
              </h2>
          ...
          <div className="flex items-center gap-4   max-sm:items-start max-sm:flex-col max-sm:w-[100%]">
            <h2 className="font-PPNeueMachina font-extrabold  text-[96px] max-sm:text-[32px] max-3xl:text-[52px]">
              СПАСИБО!
            </h2>
            <ButtonUI
              type="submit"
      ...
      <div
        ...
        className={
          "fixed right-[20px] top-0 bottom-0 flex items-center justify-center w-[120px] max-md:hidden"
        }
      >
        <BackgroundCircle
          className={
            "absolute top-[100px] right-[-120px] max-md:hidden !bg-[#00B6EC]"
          }
        />
        <div className={"flex flex-col items-center gap-[20px] z-10"}>
          <motion.img
            ...
            alt=""
            className={
              "w-[66px] h-[66px] object-contain relative top-[-20px] right-[-20px]"
            }
            initial={{ rotate: 0 }}
            animate={{ rotate: 30 }}
            transition={{
          ...
          <motion.img
            ...
            alt=""
            className={
              "w-[66px] h-[66px] object-contain relative top-[20px] right-[-30px]"
            }
            initial={{ rotate: 0 }}
            animate={{ rotate: 40 }}
            transition={{
      ...
      <div className={"absolute bottom-[50px] right-[80px]"}>
        <span className={"text-[16px] font-montserrat text-white/50"}>
          United Kingdom support@clickcontent.eu
        </span>
      </div>
    </div>
  );
