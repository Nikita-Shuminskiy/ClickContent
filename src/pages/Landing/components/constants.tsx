...
export const cardsAbout = [
    ...
    {
        title: <>ВЫГОДНЫЕ  <br/> ПОКУПКИ</>,
        text: <> Покупатели получают кэшбек благодаря MCC-коду «оплата цифровых товаров»</>,
        color: "bg-[#3DD15E]",
        classNameImg: 'w-[313px] h-[313px] relative bottom-[170px] max-sm:bottom-[140px] max-2xl:bottom-[120px]',
    ...
    },
    {
        ...
        text: <> Телеграм бот позволяет управлять Вашим личным кабинетом в мессенджере</>,
        color: "bg-[#00B6EC]",
        classNameImg: 'h-[313px] relative bottom-[210px] max-sm:bottom-[180px] max-2xl:bottom-[140px]',
