...
const TabComponent: FunctionComponent<IProps1> = ({buyerEmail, setBuyerEmail}) => {
    ...
    return (
        <div className="max-w-[396px] relative mb-6 max-sm:mb-2">
            <div className="p-1 flex justify-between mb-3 relative rounded-[12px] border border-white/5 max-sm:mb-2">
                <button
                    className={`w-1/2 cursor-pointer rounded-[8px] pt-[8px] py-[12px] flex items-center justify-center gap-2 text-[12px] leading-[14px] font-normal ${activeTab === 'email' ? 'text-white bg-[#FFFFFF0D]' : 'text-black'}`}
                ...
                <button
                    className={`w-1/2 py-[10px] text-transparent px-[20px] pointer-events-none text-[16px] relative z-10 ${activeTab === 'telegram' ? 'text-white' : 'text-black'}`}
            ...
            <div className="relative overflow-hidden">
                <div
                    className={`w-full transition-opacity duration-300 ${activeTab === 'email' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                    <InputUI
                        value={buyerEmail}
                ...
                <div
                    className={`absolute w-full transition-opacity duration-300 ${activeTab === 'telegram' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
