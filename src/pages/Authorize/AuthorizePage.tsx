...
const AuthorizePage = () => {
    ...
    const renderComponent = () => {
        switch (paramStatus) {
            case 'telegram' : {
                return <TelegramAuth setIsError={setIsError} setIsInitLoading={setIsInitLoading}/>
            }
            case 'rim' : {
                return <PassportVerify error={isError}
            ...
            default: {
                if (paramCode && paramSessionState) return <TinkoffAuthVerify
                    error={isError}
                    setIsError={setIsError}
                    setIsInitLoading={setIsInitLoading}/>
            }
    ...
    return (
        <section className="pt-[80px] pb-[80px] max-sm:pt-[40px] max-sm:pb-[40px] h-screen">
            ...
            {isInitLoading && paramStatus !== 'fail' &&
                <Loading/>}
