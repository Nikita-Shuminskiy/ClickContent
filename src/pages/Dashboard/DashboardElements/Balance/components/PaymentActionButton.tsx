...
export const PaymentActionButton: FunctionComponent = memo(() => {
    ...
    const showByAccountType = user?.accountType == "Influencer" || user?.accountType == "PassportVerified"
    ...
    const btn = <ButtonUI
        ...
        onClick={() => {
            ...
            openCardSheet({
                ...
                description: 'Вы можете вывести денежные средства поочередно на несколько карт'
            })
        }}
    >
        {
