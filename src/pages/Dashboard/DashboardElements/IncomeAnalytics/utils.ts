import {IAnalyticsSalesDto, IGetAnalyticsFinanceDto} from "@/data-contracts.ts";
...
export const getTransformAnalytics = (analyticsFinances: IGetAnalyticsFinanceDto[]): AnalyticsChartType => {
...
export const getTransformSalesAnalytics = (analyticsSales: IAnalyticsSalesDto[]) => {
