...
const ChartIncome = ({ data }: { data?: { payouts: number; quicklinks: number } }) => {
    const hasData = data && [data?.payouts, data?.quicklinks].some((value) => value > 0);
    ...
    return (
        <Doughnut
            ...
            options={{...doughnutIncomeByDaysOptions,
                plugins: {
                    tooltip: {
