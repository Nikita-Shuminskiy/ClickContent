...
const PaymentPage = () => {
    ...
    const {mutateAsync: pay, isPending: isPendingQuickPay} = usePayForQuickLink()
                ...
                <PaymentCard>
                    ...
                    <AnimatePresence>
                        {isPanelOpen && (
                            ...
                            >
                                <TelegramFastAccess close={togglePanelTelegram} payByTelegram={payByTelegram}/>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <div className='max-sm:h-full max-sm:flex max-sm:flex-col max-sm:justify-between'>
                        ...
                        <div>
                            <PaymentCard.MainInfo title={quickLink.title}
                                                  amount={amount}
