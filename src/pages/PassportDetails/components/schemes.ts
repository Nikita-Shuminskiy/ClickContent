        ...
        yup
            .object({
                surname: yup
                    ...
                    .matches(/^[а-яА-ЯёЁa-zA-Z]+$/, "Фамилия должна содержать только буквы"),
                firstName: yup
                    .string()
                ...
                middleName: yup
                    .string()
                    .notRequired()
                    .matches(/^[а-яА-ЯёЁa-zA-Z]*$/, "Отчество должно содержать только буквы"),
                ...
                dateOfBirth: yup.string().required("Укажите дату рождения, формат дд/мм/гггг"),
                dateOfIssue: yup.string().required("Укажите дату выдачи, формат дд/мм/гггг"),
