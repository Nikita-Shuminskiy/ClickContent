...
export const getIncome = async (payload: { period: string }) => {
  const response = await api.get<GetIncomeRequest>(uiInstance, {
...
export const getSales = async (payload: { period: string }) => {
  const response = await api.get<GetSalesRequest>(uiInstance, {
...
export const getFinance = async (payload: { period: string }) => {
  const response = await api.get<GetFinanceRequest>(uiInstance, {
...
type GetIncomingPaymentsRequest = ApiRequest<
  "ANALYTICS.GET_INCOMING",
  {
    from: string | null;
    to: string | null;
  },
...
export const getIncomingPayments = async (
  ...
  const response = await api.get<GetIncomingPaymentsRequest>(uiInstance, {
...
type GetPayoutsRequest = ApiRequest<
  "ANALYTICS.GET_PAYOUTS",
  {
    from: string | null;
    to: string | null;
  },
...
export const getPayouts = async (
  ...
  const response = await api.get<GetPayoutsRequest>(uiInstance, {
...
type GetIncomingPaymentsSearchRequest = ApiRequest<
  "ANALYTICS.GET_INCOMING_SEARCH",
  { id: string },
  void,
  any[]
>;

export const getIncomingSearchPayments = async (id: string): Promise<any[]> => {
  const response = await api.get<GetIncomingPaymentsSearchRequest>(uiInstance, {
