import { ICreateQuickLinkDto, ICreateQuickLink, IEditQuickLink, IQuickLinkDto } from '@/data-contracts.ts'
...
export const createQuickLink = async (data: ICreateQuickLink): Promise<ICreateQuickLinkDto> => {
    const response = await api.post<CreateQuickLinkRequest>(
        uiInstance, {
...
export const createQuickLinkValidation = async (data: ICreateQuickLink): Promise<any> => {
...
export const editQuickLink = async (data: IEditQuickLink): Promise<ICreateQuickLinkDto> => {
    const { id, ...rest } = data
    const response = await api.put<EditQuickLinkRequest>(
        uiInstance, {
            url: 'quicklink/:id',
            urlVariables: { id },
            body: { ...rest },
...
export const deleteQuickLink = async (id: string) => {
    await api.delete<DeleteQuickLinkRequest>(
        uiInstance, {
            url: 'quicklink/:id',
            urlVariables: { id },
        })
...
export const getOwnerQuickLinks = async () => {
    const response = await api.get<GetOwnerQuickLinksRequest>(
        uiInstance, {
            url: 'quicklink/all',
        })
...
export const getQuickLink = async (id?: string, paymentId?: number) => {
    const response = await api.get<GetQuickLinkRequest>(
        uiInstance, {
            url: 'quicklink/:id',
            urlVariables: { id },
            urlParams: { paymentId }
