...
const TelegramWidget = lazy(() => import('@/pages/TelegramWidget/TelegramWidget.tsx'));
const OldReceipt = lazy(() => import('@/pages/Receipt/old-receipt/old-receipt'));

const Feedback = lazy(() => import('@/pages/Feedback/Feedback.tsx'));
const OldPaymentPage = lazy(() => import('@/pages/old-disign-payments-page/old-payment-page'));
