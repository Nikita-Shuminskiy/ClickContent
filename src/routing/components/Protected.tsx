...
import {getUnAuthFromCookie, getUserFromCookie} from "@/helpers/GetUserFromCookie.ts";
...
const Protected = ({children}: { children: React.ReactNode }) => {
    ...
    if (isLoading) {
        return <div className={'flex justify-center items-center h-screen'}><SpinerUI/></div>
    }
