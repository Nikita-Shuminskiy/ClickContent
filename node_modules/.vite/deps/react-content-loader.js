...
var SVG = function(_a) {
  ...
  var dur = speed + "s";
  var gradientTransform = gradientDirection === "top-bottom" ? "rotate(90)" : void 0;
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("rect", { role: "presentation", x: "0", y: "0", width: "100%", height: "100%", clipPath: "url(" + baseUrl + "#" + idClip + ")", style: { fill: "url(" + baseUrl + "#" + idGradient + ")" } }),
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("stop", { offset: "0%", stopColor: backgroundColor, stopOpacity: backgroundOpacity }, animate && (0, import_react.createElement)("animate", { attributeName: "offset", values: -gradientRatio + "; " + -gradientRatio + "; 1", keyTimes, dur, repeatCount: "indefinite", begin: animateBegin })),
        (0, import_react.createElement)("stop", { offset: "50%", stopColor: foregroundColor, stopOpacity: foregroundOpacity }, animate && (0, import_react.createElement)("animate", { attributeName: "offset", values: -gradientRatio / 2 + "; " + -gradientRatio / 2 + "; " + (1 + gradientRatio / 2), keyTimes, dur, repeatCount: "indefinite", begin: animateBegin })),
        (0, import_react.createElement)("stop", { offset: "100%", stopColor: backgroundColor, stopOpacity: backgroundOpacity }, animate && (0, import_react.createElement)("animate", { attributeName: "offset", values: "0; 0; " + (1 + gradientRatio), keyTimes, dur, repeatCount: "indefinite", begin: animateBegin }))
      )
    )
  );
};
